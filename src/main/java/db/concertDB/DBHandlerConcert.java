...
public class DBHandlerConcert {
    ...
    public void concertsFilling(Concert concert) {
        String insertConcert = "INSERT INTO " + ConcertsConst.CONCERTS_TABLE + "(" +
                ...
                "," + ConcertsConst.CONCERT_DATE +"," + ConcertsConst.CONCERT_ADDRESS +
        ...
        try {
            ...
            prSt.setString(3,concert.getConcertDate());
            prSt.setString(4,concert.getConcertAddress());
            prSt.setString(5,concert.getConcertGenre());
            prSt.setString(6,concert.getConcertAgeLimit());
            prSt.setString(7,concert.getConcertDescription());
            prSt.setString(8,concert.getConcertImageLink());
            prSt.setString(9,concert.getConcertImageSource());
    ...
    public ResultSet getDateConcert(Concert concert){

        ResultSet resSet = null;

        String select = "SELECT * FROM " + ConcertsConst.CONCERTS_TABLE + " WHERE " + ConcertsConst.CONCERT_DATE + " =?";
        try {
            PreparedStatement prSt = getDbConnectionConcert().prepareStatement(select);
            prSt.setString(1,concert.getConcertDate());
